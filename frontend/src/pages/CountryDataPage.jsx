      ...
      <header className="bg-navy text-white h-14 flex items-center px-4 sticky top-0 z-50 shadow-md">
        <div className="flex items-center justify-between w-full max-w-7xl mx-auto gap-4">
          ...
          <div className="relative flex-shrink-0" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-1.5 w-64 bg-white border border-slate-200 rounded-lg shadow-2xl z-50 overflow-hidden text-slate-800">
                <div className="p-2 border-b border-slate-100 bg-slate-50">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-8 pl-8 pr-3 text-xs border border-slate-200 rounded focus:outline-none focus:border-navy bg-white"
                    />
                  </div>
                </div>
                    ...
                    filteredCountries.map(c => (
                      <li key={c.code}>
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 hover:bg-slate-100 transition-colors flex items-center justify-between ${c.code === countryCode ? 'bg-navy/10 font-bold text-navy' : ''}`}
                        >
                          <span>{c.name}</span>
                          {c.code === countryCode && <span className="text-[10px] text-navy">Active</span>}
                        </button>
                      </li>
                    ))
                  )}
